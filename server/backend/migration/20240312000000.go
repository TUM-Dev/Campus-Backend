...
func migrate20240312000000() *gormigrate.Migration {
	return &gormigrate.Migration{
		...
		Migrate: func(tx *gorm.DB) error {
			...
			return tx.Exec("create unique index receiver_reply_to_feedback_app_version_uindex on feedback (receiver(255), reply_to(100), feedback(255), app_version(100)) using hash").Error
		},
