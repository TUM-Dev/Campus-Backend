...
func migrate20240311000000() *gormigrate.Migration {
	return &gormigrate.Migration{
		...
		Migrate: func(tx *gorm.DB) error {
			...
			if err := tx.Exec("alter table dish modify dish int not null auto_increment").Error; err != nil {
				return err
			}
		...
		Rollback: func(tx *gorm.DB) error {
			...
			if err := tx.Exec("alter table dish modify dish int auto_increment").Error; err != nil {
				return err
			}
