...
const (
	...
	Campus_IOSNewExamsHookCallback_FullMethodName  = "/api.Campus/IOSNewExamsHookCallback"
)
...
func (c *campusClient) IOSNewExamsHookCallback(ctx context.Context, in *NewExamsHookRequest, opts ...grpc.CallOption) (*NewExamsHookReply, error) {
	...
	err := c.cc.Invoke(ctx, Campus_IOSNewExamsHookCallback_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Campus_IOSNewExamsHookCallback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Campus_IOSNewExamsHookCallback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
