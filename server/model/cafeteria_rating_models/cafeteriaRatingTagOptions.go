...
type CafeteriaRatingTagOption struct {
	CafeteriaRatingsTagsOptions int32  `gorm:"primary_key;AUTO_INCREMENT;column:cafeteriaRatingsTagsOptions;type:int;" json:"cafeteriaRatingsTagsOptions"`
...
func (n *CafeteriaRatingTagOption) TableName() string {
	return "cafeteria_rating_tag_options"
}
