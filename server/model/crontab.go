...
type Crontab struct {
	...
	Type     null.String `gorm:"column:type;type:enum ('news', 'mensa', 'movie', 'roomfinder', 'alarm', 'fileDownload','dishNameDownload','averageRatingComputation', 'canteenHeadCount', 'newExamResultsHook');" json:"type"`
